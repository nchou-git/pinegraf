                ...
                input=[
                    {
                        ...
                        "content": (
                            ...
                            "partners), not the alumnus themself. For connections: only list a "
                            "person if the page (a) explicitly names them AND (b) explicitly "
                            "describes a working, educational, or personal relationship with the "
                            "named alumnus. Mere co-occurrence of two names on a page is NOT a "
                            "connection. Skip generic mentions. If the page appears to be about a "
